		...
		return (
			<div className='dashboard-sidebar' style={{ width: width + "%", whiteSpace: "nowrap" }}>
				<div className='sidebar-wrapper'>
					<div className={'sidebar-item sidebar-add'} onClick={handleOpen.bind(this, 'project')}><div className='item-text'>Create New Project</div></div>
					...
					<div className={'sidebar-item sidebar-add'} onClick={handleOpen.bind(this, 'tileset')}><div className='item-text'>Create New Tileset</div></div>
					<div className={'sidebar-item ' + this.getClassName("tilesets")} onClick={handleSelect.bind(this, 'tilesets')}><div className='item-text'>All Tilesets</div></div>
