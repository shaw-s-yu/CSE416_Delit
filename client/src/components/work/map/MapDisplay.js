...
class ImageWrapper extends React.Component {
    ...
    componentDidMount() {
        ...
        this.mapImageController = new MapImageController(canvas, map)

        const { canvasWidth, canvasHeight } = this.mapImageController.getCanvasDimension()
        this.setState({ canvasWidth, canvasHeight }, () => {
            this.mapImageController.drawBackGround()
        })
    }
